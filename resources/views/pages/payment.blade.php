					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_delete">
								...
								<a class="cart_quantity_delete" href="{{URL::to('/deletecart/'.$v_contents->rowId)}}"><i class="fa fa-times"></i></a>
							</td>
						</tr>
                       <?php }?>
	...
	<div class="container">
		...
		<div class="paymentCont col-sm-8">
				...
				<div class="paymentWrap" >
					<h1>Sorry!Not Available Now<h1>
				       ...
				       <label class="btn paymentMethod">
				                ...
				                <input type="radio" name="payment" value="payza"> 
				            </label>
				            <label class="btn paymentMethod">
				...
				<form action="{{url('/orderplace')}}" method="post">
					{{csrf_field()}}
					<input type="radio" name="payment_method" value="handcash" checked>Handcash<br> 
					<input type="radio" name="payment_method" value="card" >Debit Card<br> 
					<input type="radio" name="payment_method" value="bcash" >Bkash<br>
					<input type="submit" value="Done" class="btn btn-success  btn-lg"> 
				</form>	
			</div>
	</div>
